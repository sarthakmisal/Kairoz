          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Streamline your productivity with our comprehensive task management platform.
              </p>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200">Dashboard</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200">Tasks</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200">Projects</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200">Team</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200">Contact Us</a></li>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">Get the latest updates and features.</p>
          ...
          <div className="mt-6 md:mt-8 pt-6 border-t border-gray-200">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-gray-600">
                ...
                <a href="#" className="hover:text-gray-900 transition-colors duration-200">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
